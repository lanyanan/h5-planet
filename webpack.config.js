...
var entrys_dir = ['diaryShare','sharePic', 'pointsDetails','details'];
var entry = {};
for(let x in entrys_dir){
	entry[entrys_dir[x]] = './src/app/' + entrys_dir[x] + '/entrys/index.js';
	var HtmlPlugin = { 
...
module.exports = {
	...
	output: { 
		...
		publicPath: config.staticUrl + 'dist/',				//模板、样式、脚本、图片等资源对应的server上的路径
